...
//    }
    ...
    public static javax.security.cert.X509Certificate toJavaxX509Certificate(Object o)
        throws Exception
    {
        if (o instanceof byte[])
        {
            return javax.security.cert.X509Certificate.getInstance((byte[])o);
        }
        else if (o instanceof java.security.cert.Certificate)
        {
            return javax.security.cert.X509Certificate.getInstance(new ByteArrayInputStream(((Certificate)o).getEncoded()));
        }
        else if (o instanceof X509CertificateHolder)
        {
            return javax.security.cert.X509Certificate.getInstance(((X509CertificateHolder)o).getEncoded());
        }
        else
        {
