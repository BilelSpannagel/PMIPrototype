...
import org.jscep.client.verification.*;
 ...
 */
public class OpenXPKICRLVerifier implements ICRLVerifier {
    ...
    public void verifyCertificateCRLs(X509Certificate cert) throws CertificateVerificationException {
        ...
        try {
            ...
            throw new CertificateVerificationException("Problem while downloading the certificate:\n" + e.getMessage());
        }
