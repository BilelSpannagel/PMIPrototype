...
public class ValidationTest {
    ...
    public static void main(String[] args) throws IOException, ClientException, CertStoreException, CertificateVerificationException, OperatorCreationException, CertificateException, OperationFailureException, NoSuchAlgorithmException {
        ...
        org.jscep.validation.CertificateVerifier.verifyCertificate(certificateToCheck, caCertificates);
    ...
    private static X509CRL getRevocationList(X509Certificate certificate) throws MalformedURLException, NoSuchAlgorithmException, CertificateException, OperatorCreationException, ClientException, OperationFailureException {
        ...
        // CN=SCEP, OU=Test CA, DC=OpenXPKI, DC=ORG
        // "CN=Root CA,OU=Test CA,DC=OpenXPKI,DC=ORG"
        // CN=CA ONE, OU=Test CA, DC=OpenXPKI, DC=ORG
        // CN=jscep.org,OU=Test CA,DC=OpenXPKI,DC=ORG
