...
public class RecordsFile extends BaseRecordsFile {
   ...
   * is cached in memory. The hashtable maps a key of type String to a main.java.RecordHeader.
   */
  ...
  /**
   * This method searches the file for free space and then returns a main.java.RecordHeader
