...
public abstract class BaseRecordsFile {
  ...
  /**
   * Locates space for a new record of dataLength size and initializes a main.java.RecordHeader.
   */
   ...
   * in the file is part of the record data of the main.java.RecordHeader which is returned.  Returns null if
  ...
  /**
   * Updates the contents of the given record. A main.java.RecordsFileException is thrown if the new data does not
